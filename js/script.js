...
var switchMenuToActive = function () {
    ...
    // Build HTML for the home page based on categories array returned from server
    function buildAndShowHomeHTML (categories) {
        ...
        false); // false here cause we're getting regular HTML from server, no need to process JSON
    }
    ...
    // Build HTML for the single category page based on the data from server
        ...
        $ajaxUtils.sendGetRequest(
            ...
            function (menuItemsTitleHtml) {
                ...
                $ajaxUtils.sendGetRequest(
                    ...
                    false); // Ajax request does not need to process this snippet as json
            },
            false);
    }
